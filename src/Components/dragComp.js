...
class DragComponent extends Component {
  ...
  render() {
    return (
      <div
        className={this.props.id === this.props.clickId ? "block" : "hidden"}
      ...
      >
        ...
        <MeetingModal
          selectedTimeId={this.props.time}
          show={this.state.modalShow}
          modalHandler={this.modeShowHandler}
          dataProb={this.props.data.timeProps}
        />
      </div>
